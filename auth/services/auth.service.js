...
export default class authService {
    ...
    static async register(user) {
      ...
      if (exist) throw new InvalidArgumentsError('USER_ALREADY_EXIST');
    ...
    static async login(user) {
      ...
      if (!dbUser || !dbUser.validPassword(user.password)) throw new UnauthenticatedError('INVALID_USERNAME_OR_PASSWORD');
